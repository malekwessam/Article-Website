...
namespace ArticleProject.Controllers
{
    ...
    public class PostController : Controller
    {
        ...
        private readonly IDataHelper<Post> dataHelper;
        ...
        public PostController(IDataHelper<Post> dataHelper,
        ...
        public ActionResult Create(ViewModel.PostViewModel collection)
        {
            setUser();
            try
            {
                var post =new Post
                {
                    ...
                    UserId = UserId,
                    FullName = dataHelperForAuthor.GetAllData().Where(x => x.UserId == UserId).Select(x => x.FullName).FirstOrDefault(),
        ...
        public ActionResult Edit(int id)
        {
            ...
            ViewModel.PostViewModel authorPostView = new ViewModel.PostViewModel
            {
                AvailableSince = authorpost.AvailableSince,
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, ViewModel.PostViewModel collection)
        {
            try
            {
                var Post = new Post
        ...
        public ActionResult Delete(int id, Post collection)
        {
            try
            {
                ...
                string filePath = "~/Images/" + collection.BathImage;
