...
namespace ArticlProject.Pages
{
    ...
    public class AdminIndexModel : PageModel
    {
        ...
        public AdminIndexModel(IDataHelper<Post> dataHelper)
        {
        ...
        public void OnGet()
        {
            ...
            PostLastMouth = dataHelper.GetDataByUser(userid).Where(x => x.AvailableSince >= datem).Count();
            PostThisYear = dataHelper.GetDataByUser(userid).Where(x => x.AvailableSince >= datey).Count();
        }
    }
}
